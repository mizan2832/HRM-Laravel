    ...
    <div class="container mt-2">
        <div style="margin-top: 70px;" class="row col-md-12 col-sm-12 col-lg-12">
            <div class="card col-md-6 col-sm-6 col-lg-6">
              ...
              @endif
                <h2 style="background:gray;">Unit Form</h2>
                @if ($errors->any())
                          ...
                          <tr>
                              <td>{{ $u->name }}</td>
                                ...
                                <td>
                                  ...
                                  <a href="" onclick="if(confirm('Do you want to delete this unit?'))event.preventDefault(); document.getElementById('delete-{{$u->name}}').submit();" class="btn btn-sm btn-outline-danger py-0"><i class="fas fa-trash-alt"></i></a></a>
