            ...
            <div class="card col-md-6 col-sm-6 col-lg-6">
              ...
              @endif
                ...
                @if ($errors->any())
                    ...
                    @endforeach
                 @endif
                <form class="form-inline" action="{{ route('section.store') }}" method="POST" >
                    @csrf
                    <label for="section" class="mb-2 mr-sm-2">section:</label>
                    <input type="text" value="{{ old('section') }}" class="form-control mb-2 mr-sm-2" id="section" placeholder="Enter section" name="name">
